(function() {
	...
	Observable.prototype.share = function(subject = new Subject()) {
		let observers = [];
		let subscription;

		let o = new Observable(observer => {
			o.subscribe = subject.subscribe.bind(subject);
			return this.subscribe(subject);

			// observers.push(observer);
			// subscription = subscription || this.subscribe(subject);
	...
	Observable.combine = function(...observables) {
		...
		return new Observable(observer => {
			...
			const combine = (observable, index) => {
